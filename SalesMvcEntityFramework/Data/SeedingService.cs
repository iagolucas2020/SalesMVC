...
using SalesMvcEntityFramework.Models.Enums;

namespace SalesMvcEntityFramework.Data
{
    public class SeedingService
    {
        private SalesMvcEntityFrameworkContext _context;

        public SeedingService(SalesMvcEntityFrameworkContext context)
        {
            _context = context;
        }
